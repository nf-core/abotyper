...
class SampleRenamer:
    ...
    def preprocess_renaming_file(self, renaming_file: pd.DataFrame) -> pd.DataFrame:
        """Rename columns, extract the first value from a comma-separated
        Grid_number column, and filter out invalid entries."""
        ...
        # Rows where Grid_number starts with a letter are invalid samples.
    ...
    def write_output_files(
        ...
        """Write DataFrames to output files with date suffix. Returns
        (path_with_acc, path_without_acc)."""
    ...
    def process_samples(
        ...
        """Rename samples and generate output files."""
